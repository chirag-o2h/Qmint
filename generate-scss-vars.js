...
console.log("🚀 ~ test:","process.env.GATSBY_REACT_APP_BMK_THEME_MAIN_COLOR", process.env.GATSBY_REACT_APP_BMK_THEME_MAIN_COLOR,"-->REACT_APP_BMK_THEME_MAIN_COLOR", process.env.REACT_APP_BMK_THEME_MAIN_COLOR,"=>mode", process.env.NODE_ENV,process.env.THEME_TYPE)
