                        ...
                        <Fragment key={category.name}><HoverTooltip
                          ...
                          renderComponent={
                            <Link
                              ...
                              href={category?.type == 2 ? formatCategoryUrl(category.searchEngineFriendlyPageName) :
                                category?.type == 1 ? '/category' + formatCategoryUrl(category.searchEngineFriendlyPageName)
